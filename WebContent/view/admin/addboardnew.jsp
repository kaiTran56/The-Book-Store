              ...
              <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/new/add" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-2" placeholder="News" name="new-title">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-18" placeholder="url of image" name="new-image_link">
                  </div>
	               <div class="form-group">
