      ...
      <div class="container-fluid">
            ...
            <div class="card">
	         ...
	         <div class="form-group">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <input type="password" class="form-control" id="myinput" name="password" value="${admin.password}">
        <input type="checkbox" onclick="myFunction1()">Show password
                    <script>function myFunction1() {
	                  ...
	                  <div class="form-group">
	                    <label for="input-1">Name's Admin</label>
	                    <input type="text" class="form-control" id="input-1"  name="name" value="${admin.name}">
	                  </div>	                  		              
