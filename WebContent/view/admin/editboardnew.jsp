              ...
              <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/new/edit" method="post">
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" readonly id="input-1" ="ID" value="${boardnew.id}" name="new-id">
                  </div>
                  <div class="form-group">
                    <label for="input-2">Title</label>
                    <input type="text" class="form-control" id="input-2"  value="${boardnew.title}"name="new-title">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-10"  value="${boardnew.image_link}"name="new-image_link">
                  </div>
	               <div class="form-group">
