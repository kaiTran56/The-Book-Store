                ...
                <hr>
	                ...
	                <form action="${pageContext.request.contextPath}/admin/cate/edit" method="post">
	                  <div class="form-group">
	                    ...
	                    <input type="text" class="form-control" readonly id="input-1"  "ID" name="id" value="${catelist.id}">
	                  </div>
	                  <div class="form-group">
	                    <label for="input-1">Name </label>
	                    <input type="text" class="form-control" id="input-1"  name="name" value="${catelist.name }">
	                  </div>
		              <div class="form-group">
