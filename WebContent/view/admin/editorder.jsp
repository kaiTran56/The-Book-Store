              ...
              <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/order/edit">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" readonly="readonly" id="input-1" "Mã sản phẩm" name="order-id" value="${order.id}">
                  </div>
                  
                  <div class="form-group">
                    <label for="input-1">Guest</label>
                 ...
                 <div class="form-group">
                  <label for="input-2" class="col-form-label">Address</label>
                  <div>
                    <textarea class="form-control" rows="4" id="input-17" name="order-address">${order.address}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input-2" class="col-form-label">Note</label>
                  <div>
                    ...
                    <div class="form-group">
	                  ...
	                  <div>
	                    <select class="form-control valid" id="input-6" name="order-status" required aria-invalid="false">
	                        ...
	                        <option value="" selected="selected">Not Pay</option>
	                    </select>
	                  </div>
	                </div>
	          
		               <div class="form-footer">
		                     <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/order/list">Cancel</a></button>
